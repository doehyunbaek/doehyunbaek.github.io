...
- Week view uses a Google Calendar-style per-hour timeline grid
...
- Google Calendar-style top bar, configurable left/bottom/right multipanel sidebar, month grid, GitHub-style worked-hours heatmap spanning the first-to-last visible selected-calendar event with clicked-day details, and right rail
- Create/edit/delete events; Create event defaults to the earliest currently visible calendar; Time analysis sidebar panel summarizes all visible events in the current view
