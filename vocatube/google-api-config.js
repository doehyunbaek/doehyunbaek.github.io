window.VOCATUBE_GOOGLE_CONFIG = {
  // Set this to the URL printed by `npm run deploy` for static hosting.
  // Leave empty when using `node server.js` locally.
  youtubeWorkerUrl: "https://vocatube-youtube.doehyunbaek.workers.dev",
  firebaseConfig: {
